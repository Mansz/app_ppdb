      ...
      <div class="panel panel-flat bg-info">
        <div class="panel-heading">
          <h3 class="panel-title">
            <center>Selamat Datang Calon Siswa SMK NURUL HAYYAH, <?php echo ucwords($nama); ?></center>
          </h3>
        </div>
      </div>
      <!-- /basic datatable -->
        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-flat bg-success">
              <div class="panel-heading">
                <h4 class="panel-title">
                  <center>
                    <i class="glyphicon glyphicon-bullhorn"></i> Selamat <b><?php echo $nama; ?></b> <span class="label label-info" style="font-size:20px;">Lulus</span> Seleksi Sebagai Calon Peserta Didik Baru <b>SMK NURUL HAYYAH</b>, Silahkan Cetak Surat Pengumuman Sebagai Bukti Lulus Seleksi.
          ...
          <div class="row">
            ...
            <div class="col-lg-3">
              <!-- Current server load -->
            <center>
              <a href="files/Panduan_PPDB_Online_SMKNURULHAYYAH.pdf">
